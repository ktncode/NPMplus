...
import internalDomainLog from "./domain-log.js";
...
const internalProxyHost = {
	...
	get: async (access, data) => {
		...
		const query = proxyHostModel
			...
			.allowGraph("[owner,access_list.[clients,items],certificate.acme_server]")
			.first();
		...
		const internalSetting = await import('./setting.js');
		thisRow.crowdsec_enabled = internalSetting.default.isCrowdSecEnabled();
